...
const SAMPLE_ITEMS = [
  ...
  { name: 'Luna Silver Anklet', category: 'Silver', material: '925 Sterling Silver', price: 3200, weight: 12, quantity: 15, featured: true, description: 'A dainty sterling silver anklet with a soft, everyday shine.', images: ['https://images.unsplash.com/photo-1608042314453-ae338d80c427?w=900&q=80'] },
  { name: 'Aria Silver Toe Rings', category: 'Silver', material: '925 Sterling Silver', price: 1800, weight: 6, quantity: 20, featured: false, description: 'Classic adjustable silver toe rings, sold as a pair.', images: ['https://images.unsplash.com/photo-1611652022419-a9419f74343d?w=900&q=80'] },
  { name: 'Vera Silver Oxidised Jhumkas', category: 'Silver', material: '925 Oxidised Silver', price: 4200, weight: 9, quantity: 10, featured: true, description: 'Hand-crafted oxidised silver jhumkas with an antique finish.', images: ['https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=900&q=80'] },
  { name: 'Mira Silver Chain Bracelet', category: 'Silver', material: '925 Sterling Silver', price: 2600, weight: 8, quantity: 18, featured: false, description: 'A sleek sterling silver chain bracelet for daily wear.', images: ['https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=900&q=80'] },
]
